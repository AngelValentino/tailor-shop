export default class GarmentSlider {
  constructor(garmentInfoCollection, collection) {
    ...
    this.garmentSliderControlsSVGs = {
      'built-jacket': `
        <svg class="garment-slider__control-btn-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      `,
      'pleated-trousers': `
        <svg class="garment-slider__control-btn-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
